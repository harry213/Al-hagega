        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="block-area">
              ...
              <div class="block-title-6 ">
                <h4 class="h5 border-primary">
                  <span class="bg-primary text-white arabic-kufi">الرياضة</span>
                </h4>
              </div>
              <!--block content-->
              <div class="row">
            ...
            <div class="block-area">
              ...
              <div class="block-title-6">
                <h4 class="h5 border-primary">
                  <span class="bg-primary text-white arabic-kufi">مزيد من الاخبار الرياضية</span>
                </h4>
              </div>
              <!-- block content -->
          ...
          <aside class="col-md-4 end-sidebar-lg">
            <div class="sticky">
              ...
              <aside class="widget">
                ...
                <div class="block-title-9">
                  <h4 class="h5">
                    <span class="border-primary bg-secondary text-white arabic-kufi">الرياضية</span>
                  </h4>
                </div>
                <!-- block content -->
                <div class="small-post">
...
export default {
   ...
   async setup() {
        const topsection = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=4&LIMIT=1&OFFSET=0")
          .then((response) => { return response.data.getPostbyCateogry; });
        const topsection1 = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=4&LIMIT=4&OFFSET=1")
          .then((response) => { return response.data.getPostbyCateogry; });
        const topsection2 = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=4&LIMIT=1&OFFSET=2")
          .then((response) => { return response.data.getPostbyCateogry; });
        const topsection3 = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=4&LIMIT=3&OFFSET=3")
          .then((response) => { return response.data.getPostbyCateogry; });

        const topsection4 = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=4&LIMIT=4&OFFSET=6")
          .then((response) => { return response.data.getPostbyCateogry; });
        const topsection5 = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=4&LIMIT=5&OFFSET=10")
          .then((response) => { return response.data.getPostbyCateogry; });
        // const topsection6 = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=4&LIMIT=4&OFFSET=15")
        //   .then((response) => { return response.data.getPostbyCateogry; });
        // const topsection7 = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=4&LIMIT=1&OFFSET=19")
        //   .then((response) => { return response.data.getPostbyCateogry; });
        // const topsection8 = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=4&LIMIT=3&OFFSET=20")
        //   .then((response) => { return response.data.getPostbyCateogry; });
        // const lastnews = await axios.get("getPost.php?getPost&LIMIT=4&OFFSET=0")
        //   .then((response) => { return response.data.getPost; });
        // const lastnews1 = await axios.get("getPost.php?getPost&LIMIT=4&OFFSET=4")
        //   .then((response) => { return response.data.getPost; });
        return {
           topsection,
           topsection1,
   ...
   mounted() {
    // policy //////////////////
      axios
      .get('getPostbyCateogry.php?getPostbyCateogry&term_id=4&LIMIT=4&OFFSET=15')
      .then((response) => (this.topsection6 = response.data.getPostbyCateogry));
      axios
      .get('getPostbyCateogry.php?getPostbyCateogry&term_id=4&LIMIT=1&OFFSET=19')
      .then((response) => (this.topsection7 = response.data.getPostbyCateogry));
      axios
      .get('getPostbyCateogry.php?getPostbyCateogry&term_id=4&LIMIT=3&OFFSET=20')
