                    ...
                    <div class="card card-full text-white overflow zoom">
                      <div class="height-ratio image-wrapper">
                        ...
                        <div class="position-absolute px-3 pb-3 pt-0 b-0 w-100 bg-shadow arabic-kufi">
                          <a class="p-1 badge bg-primary text-white" >{{ publish.name }}</a>
...
export default {
   ...
   async setup() {
        const topsection = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=1&LIMIT=1&OFFSET=0")
          .then((response) => { return response.data.getPostbyCateogry; });
        const topsection1 = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=1&LIMIT=4&OFFSET=1")
          .then((response) => { return response.data.getPostbyCateogry; });
        const topsection2 = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=1&LIMIT=1&OFFSET=2")
          .then((response) => { return response.data.getPostbyCateogry; });
        const topsection3 = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=1&LIMIT=3&OFFSET=3")
          .then((response) => { return response.data.getPostbyCateogry; });
        const topsection4 = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=1&LIMIT=4&OFFSET=6")
          .then((response) => { return response.data.getPostbyCateogry; });
        const topsection5 = await axios.get("getPostbyCateogry.php?getPostbyCateogry&term_id=1&LIMIT=5&OFFSET=10")
          .then((response) => { return response.data.getPostbyCateogry; });
   ...
   mounted() {
      axios
      .get('getPostbyCateogry.php?getPostbyCateogry&term_id=1&LIMIT=4&OFFSET=15')
      .then((response) => (this.topsection6 = response.data.getPostbyCateogry));
      axios
      .get('getPostbyCateogry.php?getPostbyCateogry&term_id=1&LIMIT=1&OFFSET=19')
      .then((response) => (this.topsection7 = response.data.getPostbyCateogry));
      axios
      .get('getPostbyCateogry.php?getPostbyCateogry&term_id=1&LIMIT=3&OFFSET=20')
